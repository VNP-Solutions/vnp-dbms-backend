...
const COLUMN_TO_FIELDS: Record<string, string[]> = {
  ...
  expedia_run_date:            ['expedia_run_date_from', 'expedia_run_date_to'],
  expedia_run_date_db:         ['expedia_run_date_db_from', 'expedia_run_date_db_to'],
  ...
  booking_run_date:            ['booking_run_date_from', 'booking_run_date_to'],
  ...
  agoda_run_date:              ['agoda_run_date_from', 'agoda_run_date_to'],
